 ...
 * helper methods.
 */
public class check_friends_req extends IntentService {
    ...
    public check_friends_req() {
        super("check_friends_req");
    }
    ...
    public static void startActionFoo(Context context, String param1, String param2) {
        Intent intent = new Intent(context, check_friends_req.class);
